...
> NOTE:
> GCP cluster deployment is supported in K0rdent 0.2.0
...
Note that if you have already done our AWS or Azure QuickStart ([QuickStart 2 - AWS target environment](./quickstart-2-aws.md))
or Azure QuickStart ([QuickStart 2 - Azure target environment](./quickstart-2-azure.md))
