...
> NOTE:
> The Secret name needs to be exactly `aws-cluster-identity-secret`, see [credential secret](../appendix/appendix-providers.md#credential-secret) for more detail.
